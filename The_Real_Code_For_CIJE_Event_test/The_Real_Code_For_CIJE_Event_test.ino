...
if(input==82 || input==71 || input==66){
  ...
  else if ( colorchoser1 == false && red >= 92 && red <= 100 && green >= 82 && green <= 86 && blue >= 52 && blue <= 55) { //red
    Serial.println("  ");
    Serial.println("License Plate: Red");
  ...
  //green
  else if ( colorchoser2 == true && red >= 88 && red <= 90 && green >= 90 && green <= 93 && blue >= 53 && blue <= 55) { //green
    Serial.println("  ");
  ...
  else if ( colorchoser2 == false && red >= 88 && red <= 90 && green >= 90 && green <= 93 && blue >= 53 && blue <= 55) { //green
    Serial.println("  ");
    Serial.println("License Plate: Green");
    Serial.println("Car Status: Civilian");
    Serial.println("Location: 1st Street");
  ...
  //black
  else if ( colorchoser3 == true && red >= 88 && red <= 91 && green >= 89 && green <= 90 && blue >= 56 && blue <= 57) { //black
    Serial.println("  ");
  ...
  else if ( colorchoser3 == false && red >= 88 && red <= 91 && green >= 89 && green <= 90 && blue >= 56 && blue <= 57) { //black
    Serial.println("  ");
    Serial.println("License Plate: Black");
    Serial.println("Car Status: Civilian");
    Serial.println("Location: 1st Street");
