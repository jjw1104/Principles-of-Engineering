...
void loop() {
  ...
  if ( colorchoser1=false && red>= 120 && red<=160 && green>= 65 && green<=90 && blue>= 40 && blue<=60) { //red
    Serial.println("License Plate: Red");
    Serial.println("Car Status: Criminal");
    Serial.println("Location: 1st Street");
  ...
  //green
   ...
   if ( colorchoser2=false && red>= 135 && red<=150 && green>= 74 && green<=82 && blue>= 48 && blue<=56) { //green
   Serial.println("License Plate: Green");
    Serial.println("Car Status: Criminal");
    Serial.println("Location: 1st Street");
  }
 ...
 if ( colorchoser3=false && red>= 135 && red<=150 && green>= 74 && green<=82 && blue>= 48 && blue<=56) { //green
   Serial.println("License Plate: Green");
    Serial.println("Car Status: Criminal");
    Serial.println("Location: 1st Street");
  }
  ...
  //white
   ...
   if ( colorchoser4=false && red>= 135 && red<=150 && green>= 74 && green<=82 && blue>= 48 && blue<=56) { //green
   Serial.println("License Plate: Green");
    Serial.println("Car Status: Criminal");
    Serial.println("Location: 1st Street");
  }
